...
本技能通过「投研数字员工」代理服务调用 WarrenQ 智能体后端（bot_id: `273760871556224`）。
...
curl.exe -N -s "${API}/api/tools/stream?skill=macro_news&q=$QUERY"
```
